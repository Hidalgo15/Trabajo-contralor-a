...
class VerificaCgrException implements Exception {
  const VerificaCgrException(this.mensaje, {this.codigo, this.detalle});
  ...
  @override
  String toString() =>
      'VerificaCgrException($codigo): $mensaje${detalle == null ? '' : ' | $detalle'}';
}
