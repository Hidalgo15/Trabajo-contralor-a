...
class VerificarConsultarEmpleadoConfig {
  const VerificarConsultarEmpleadoConfig({
...
/// Produccion. El sitio esta publicado bajo la subcarpeta `/verificacgr` en
  ...
  static const String produccion =
      'https://consultas.contraloria.gob.do/consultawscgr';
  ...
  static const String interno = 'http://192.168.3.95/consultawscgr';
  ...
  static const String endpointConsultaEmpleado = '/api/consulta/GetConsultaEmpleado';
  ...
  static const String parametroDocumento = 'cedula';
  ...
  final Duration timeout;
    ...
    VerificarConsultarEmpleadoConfig copyWith({
      String? baseUrl,
      String? recaptchaSiteKey,
      bool? validarCaptcha,
      Duration? timeout,
    }) {
      return VerificarConsultarEmpleadoConfig(
